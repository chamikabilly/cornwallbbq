                            ...
                            for ($i = 1; $i <= $cat_count; $i++) {
                                ...
                                <div class="cat-container animate-on-scroll">
                                    <a href="<?php echo ${'cat_' . $i}['category_page'] ?>">
                                        <img src="<?php echo ${'cat_' . $i}['category_image'] ?>" alt="cat-img-<?php echo $i ?>"
                ...
                <div class="col-12">
                    <div class="ss-title-holder animate-on-scroll">
                        <h3 class="ss-title animate-on-scroll">
                            <img src="<?php echo $home ?>/wp-content/themes/miheli-solutions/assets/images/text-bg-img.png"
                                alt="text-bg" class="text-bg" loading="lazy">
                            Browse Everything We've Got
                        </h3>
                        <h6 class="ss-sub-title animate-on-scroll">Lorem ipsum dolor sit amet, consectetur adipiscing
                            elit</h6>
                    </div>
                                            ...
                                            if ($rating > 0) {
                                                ...
                                                <svg width="137" height="17" viewBox="0 0 137 17" fill="none"
                                                    ...
                                                    <path
                                                        ...
                                                        fill="#FFAC42" stroke="#FFAC42" stroke-width="2" stroke-linecap="round"
        ...
        <div class="row">
            <div class="col-12">
                <div class="ts-title-holder animate-on-scroll">
                    ...
                    <h6 class="ts-sub-title animate-on-scroll">Lorem ipsum dolor sit amet, consectetur adipiscing elit
                    </h6>
                </div>
            </div>
            <div class="col-12">
