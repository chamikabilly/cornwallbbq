            ...
            <div class="row">
                <div class="col-12">
                    <div class="ss-title-holder animate-on-scroll">
                        ...
                        <h6 class="ss-sub-title animate-on-scroll">Lorem ipsum dolor sit amet, consectetur adipiscing elit</h6>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="ts-title-holder animate-on-scroll">
                    ...
                    <h6 class="ts-sub-title animate-on-scroll">Lorem ipsum dolor sit amet, consectetur adipiscing elit</h6>
                </div>
            </div>
            <div class="col-12">
                            ...
                            ?>
                                <div class="swiper-slide">
                                    <div class="ts-wrp">
                                        <div class="ts-top">
                                            <div class="ts-avatar">
                                                <img src="<?php echo $home ?>/wp-content/themes/miheli-solutions/assets/images/fallback-avatar.png" alt="user-avatar">
                                            </div>
                                        ...
                                        <div class="ts-content">
                                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos quaerat dolorem veritatis nulla molestiae amet voluptates aut ratione perspiciatis eius illum, culpa error, odio repellat libero illo similique minima quae.
                                        </div>
                                    </div>
                                </div>
                            <?php
