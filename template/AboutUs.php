    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-5 col-lg-6 col-12">
                <img src="<?php echo $home ?>/wp-content/uploads/2025/11/1-1.png" alt="about-side-img"
            ...
            <div class="col-xl-7 col-lg-6 col-12">
                <div class="sau-content-holder">
                    ...
                    <div class="aus-text animate-on-scroll">
                        <p>
                            Cornwall BBQ Supplies is a family-run business dedicated to
                            providing high-quality BBQ equipment and accessories to barbecue enthusiasts across Cornwall
                            and
                            beyond. With years of experience in the industry, we understand the passion for outdoor
                            cooking
                            and
                            strive to offer a wide range of products that cater to all levels of expertise.
                        </p>

                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam quis eros nisl. Nunc tellus
                            leo, porttitor id dapibus id, sodales sed felis. Maecenas a dapibus sem. In hac habitasse
                            platea
                            dictumst. Nulla libero lacus, consequat sed semper ut, convallis id lacus. Nam eleifend nisi
                            faucibus, tincidunt ligula quis, tempus est. Nulla facilisi. 
                        </p>
...
<section class="our-services-section">
    ...
    <h6 class="oss-sub-title animate-on-scroll">Lorem ipsum dolor sit amet, consectetur adipiscing elit</h6>
        ...
        <div class="row">
            <div class="col-lg-8 col-12">
                <div class="oss-content-holder row g-3">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="inner-content bg-dark-color h-100">
                            <h6 class="oss-inner-title">
                                Lunch
                            </h6>
                            <p class="oss-inner-text">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam quis eros nisl. Nunc
                                tellus
                                leo, porttitor id dapibus id, sodales sed felis. Maecenas a dapibus sem. In hac
                                habitasse
                                platea dictumst.
                            </p>
                    ...
                    <div class="col-md-6 col-12 ">
                        <div class="inner-content bg-light-color h-100">
                            <h6 class="oss-inner-title">
                                Dinner
                            </h6>
                            <p class="oss-inner-text">
            ...
            <div class="col-lg-4 col-12">
                <div class="oss-img-holder animate-on-scroll">
                    <img src="<?php echo $home ?>/wp-content/uploads/2025/11/2-1.png" alt="our-services-img"
                        loading="lazy">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="ts-title-holder animate-on-scroll">
                    ...
                    <h6 class="ts-sub-title animate-on-scroll">TESTIMONIALS
                    </h6>
                </div>
            </div>
            <div class="col-12">
                            ...
                            <?php for ($i = 0; $i < 5; $i++) {
                                ...
                                <div class="swiper-slide">
                                    <div class="ts-wrp">
                                        <div class="ts-top">
                                            <div class="ts-avatar">
                                                <img src="<?php echo $home ?>/wp-content/themes/miheli-solutions/assets/images/fallback-avatar.png"
                                                    alt="user-avatar" loading="lazy">
                                            </div>
                                            <div class="ts-top-content">
                                                <h6>Lorem ipsum</h6>
                                                <p class="star-rating">
                                                    <svg width="137" height="17" viewBox="0 0 137 17" fill="none"
                                        ...
                                        <div class="ts-content">
                                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos quaerat dolorem
                                            veritatis nulla molestiae amet voluptates aut ratione perspiciatis eius illum,
                                            culpa error, odio repellat libero illo similique minima quae.
                                        </div>
                                    </div>
                                </div>
                                <?php
